...
export const mockCommunityPosts: CommunityPost[] = [
  {
    ...
    excerpt: "How to plan light, weather windows, and crew call times for colder production days.",
    body:
  ...
  },
  {
    ...
    excerpt: "A Cape Town photographer building a clean natural-light portfolio for local brands.",
    body:
  ...
  },
  {
    ...
    excerpt: "A practical pre-shoot checklist for cameras, audio, power, backups, and files.",
    body:
  ...
  },
  {
    ...
    excerpt: "Bookable profiles can now surface live availability directly on profile pages.",
    body:
